...
//reset
//按照意思，现在的复位同步模块作为一个单独模块，IP内部就不需要该模块了
...
//gray code counter
//在同步FIFO中无需考虑CDC问题，因此此处我们应该不需要gray code counter
...
//组合逻辑用blocking assignment =，而不是no blocking assignment <=
